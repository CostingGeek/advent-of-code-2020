...
function derive_seat_id( $ticket, $debug = false )
{
...
// identify missing seat ID (avoid first and last seats)
for( $i = min($seat_array) + 1; $i < max($seat_array) - 1; $i++ )
{
    if( !array_search( $i, $seat_array) )
    {
      echo 'The missing seat ID is ' . $i . "\n";
    }
}
